...
Consequence in Bayesian estimation: the ordening of the states (e.g., state 1: good mood, state 2: bad mood) may switch over the iterations of the estimation procedure

In multilevel HMMs: occurs at the level of the individual estimates. Severe label switching may also affect the group level estimates. 

How to check: traceplots of the parameters at the individual level 
...
Occurrence depends on state separation, number of dependent observations in the model, and sample size: 

<div align="center">
<img src="./figures/XX.png" width=650>
</div>
